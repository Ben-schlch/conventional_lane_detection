...
class LaneDetection:
    ...
    def _draw_lines(self, img: Mat, lines: np.ndarray) -> Mat:
        ...
        if left_line is not None:
            ...
            x_left = x[y_left > img.shape[0] // 2 + 90]
            y_left = y_left[y_left > img.shape[0] // 2 + 90]
        ...
        if right_line is not None:
            ...
            x_right = x[y_right > img.shape[0] // 2 + 90]
            y_right = y_right[y_right > img.shape[0] // 2 + 90]
